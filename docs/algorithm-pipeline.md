...
> 마지막 갱신: 2026-05-08 (4.6 장축 모서리 박음 default ON 변경 + 활성 조건 강화 — 절대 길이 ≥ 300cm AND 컨 길이 25% 이상 AND 막대 형상 비율 ≤ 0.25 인 진짜 가는 봉만 통과. 3ST SG sg3-8 세아특수강 311cm 막대 단독 pack() 호출에서도 자동 발동, 큐브형 회귀 0건)
